  ...
  return (
    <>
      ...
      <section className={styles.progressContainer}>
        <span
          className={`${styles.progressGroup} ${styles.groupActive}`}
          data-phase="address"
        >
        ...
        <span
          className={`${styles.progressBar} ${styles.barActive}`}
          data-order="1"
        ></span>
        <span
          className={
            step > 1
              ? `${styles.progressGroup} ${styles.groupActive}`
        ...
        >
          <span className={styles.progressIcon}>
            <div
              className={
                step > 2
                  ? `${styles.circleContainer} ${styles.circleActive}`
        ...
        <span
          className={
            step > 1
              ? `${styles.progressBar} ${styles.barActive}`
              : `${styles.progressBar}`
          }
          data-order="2"
        ></span>
